...
/// booking Manager  ///
const booking_bus = require('./src/router/product_booking_bus');
app.use('/booking', booking_bus); 

/// resort Manager  ///
const ProductResort = require('./src/router/product_resort');
app.use('/resort', ProductResort); 

/// resort building  ///
const ProductBuiling = require('./src/router/building.router');
app.use('/building', ProductBuiling); 
